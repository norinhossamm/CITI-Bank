...
$transcquery= "SELECT * from Transaction";
$transcresult= mysqli_query($connect,$transcquery);
$count = mysqli_num_rows($transcresult);
?>
...
<!--Header-->
  ...
  <!--Customers-->
    <div class="table-heading">TRANSACTION HISTORY</div>
    <table class="responstable">
      <tr>
        ...
        <?php
          ...
          ?> 
          <?php
          foreach($transcresult as $r)
          {
          ?>
            <tr>
                <td style="border: 1px solid #D9E4E6;border-bottom:2px solid #D9E4E6;"> <?php echo $r['TID']?></td>
                <td style="border: 1px solid #D9E4E6;border-bottom:2px solid #D9E4E6;"> <?php echo $r['Sender']?></td>
                <td style="border: 1px solid #D9E4E6;border-bottom:2px solid #D9E4E6;"> <?php echo $r['Receiver']?></td>
                <td style="border: 1px solid #D9E4E6;border-bottom:2px solid #D9E4E6;"> <?php echo $r['Balance']?></td>
                <td style="border: 1px solid #D9E4E6;border-bottom:2px solid #D9E4E6;"> <?php echo $r['DateTime']?></td>
            </tr> 
          <?php
          }
          ?>
